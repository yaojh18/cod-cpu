...
parameter BASE_RAM_INIT_FILE = "C:\\Users\\verit_v7if7au\\Documents\\Eris\\code\\verilog\\cod21-grp08\\testcases\\lab5\\code_4M.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
...
initial begin 
    //锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷远锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟叫ｏ拷锟斤拷锟界：
//    dip_sw = 32'h2;
    touch_btn = 0;
    reset_btn = 1;
    #100;
...
//        #100; //锟饺达拷100ns
//        clock_btn = 1; //锟斤拷锟斤拷锟街癸拷时锟接帮拷钮
//        #100; //锟饺达拷100ns
//        clock_btn = 0; //锟缴匡拷锟街癸拷时锟接帮拷钮
//    end
//    // 模锟斤拷PC通锟斤拷锟斤拷锟节凤拷锟斤拷锟街凤拷
