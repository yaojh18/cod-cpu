...
00000000 <_start>:
   ...
   c:	55550513          	addi	a0,a0,1365 # 55555555 <__global_pointer$+0x55553c19>
  10:	12800593          	li	a1,296
  14:	d4a6e637          	lui	a2,0xd4a6e
  18:	7c160613          	addi	a2,a2,1985 # d4a6e7c1 <__global_pointer$+0xd4a6ce85>
  1c:	00a42023          	sw	a0,0(s0) # 80100000 <__global_pointer$+0x800fe6c4>
...
00000034 <t_slli>:
  ...
  50:	fff30313          	addi	t1,t1,-1 # ffff <__global_pointer$+0xe6c3>
  54:	00031313          	slli	t1,t1,0x0
  58:	01000393          	li	t2,16
  5c:	00731a63          	bne	t1,t2,70 <t_xor>
  60:	00061313          	slli	t1,a2,0x0
  64:	0061a023          	sw	t1,0(gp) # 193c <__global_pointer$>
  68:	00418193          	addi	gp,gp,4 # 1940 <__global_pointer$+0x4>
...
00000070 <t_xor>:
  ...
  7c:	00230313          	addi	t1,t1,2 # ffff0002 <__global_pointer$+0xfffee6c6>
  80:	00300393          	li	t2,3
  84:	00734333          	xor	t1,t1,t2
  88:	000303b7          	lui	t2,0x30
  8c:	00238393          	addi	t2,t2,2 # 30002 <__global_pointer$+0x2e6c6>
  90:	02731c63          	bne	t1,t2,c8 <t_sltu>
  94:	00300313          	li	t1,3
  98:	ffff13b7          	lui	t2,0xffff1
  9c:	11238393          	addi	t2,t2,274 # ffff1112 <__global_pointer$+0xfffef7d6>
  a0:	00734333          	xor	t1,t1,t2
  a4:	111203b7          	lui	t2,0x11120
  a8:	00338393          	addi	t2,t2,3 # 11120003 <__global_pointer$+0x1111e6c7>
  ac:	00731e63          	bne	t1,t2,c8 <t_sltu>
  b0:	aaaa53b7          	lui	t2,0xaaaa5
  b4:	55538393          	addi	t2,t2,1365 # aaaa5555 <__global_pointer$+0xaaaa3c19>
  b8:	00764333          	xor	t1,a2,t2
  bc:	0061a023          	sw	t1,0(gp) # 193c <__global_pointer$>
  c0:	00418193          	addi	gp,gp,4 # 1940 <__global_pointer$+0x4>
...
000000c8 <t_sltu>:
  ...
  f4:	00138393          	addi	t2,t2,1 # 12340001 <__global_pointer$+0x1233e6c5>
 ...
 114:	55530313          	addi	t1,t1,1365 # aaaa5555 <__global_pointer$+0xaaaa3c19>
 118:	00c33333          	sltu	t1,t1,a2
 11c:	0061a023          	sw	t1,0(gp) # 193c <__global_pointer$>
 120:	00418193          	addi	gp,gp,4 # 1940 <__global_pointer$+0x4>
